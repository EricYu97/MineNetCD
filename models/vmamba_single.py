...
def VSSM_ST_T(pretrained=None):
    # return Backbone_VSSM_ST(depths=[2,2,5,2], dims=[96,96*2,96*4,96*8], ssm_ratio=2.0, ssm_drop_rate=0.6, ssm_d_state=16, forward_type="v05_noz", pretrained=pretrained)
    return Backbone_VSSM_ST(depths=[2,2,5,2], dims=[96,96*2,96*4,96*8], ssm_ratio=2.0, ssm_drop_rate=0.6, ssm_d_state=1, forward_type="v05_noz", pretrained=pretrained)

def VSSM_ST_S(pretrained=None):
    # return Backbone_VSSM_ST(depths=[2,2,15,2], dims=[96,96*2,96*4,96*8], ssm_ratio=2.0, ssm_drop_rate=0.6, ssm_d_state=16, forward_type="v05_noz", pretrained=pretrained)
    return Backbone_VSSM_ST(depths=[2,2,15,2], dims=[96,96*2,96*4,96*8], ssm_ratio=2.0, ssm_drop_rate=0.6, ssm_d_state=1, forward_type="v05_noz", pretrained=pretrained)

def VSSM_ST_B(pretrained=None):
    # return Backbone_VSSM_ST(depths=[2,2,15,2], dims=[128,128*2,128*4,128*8], ssm_ratio=2.0, ssm_drop_rate=0.6, ssm_d_state=32, forward_type="v05_noz", pretrained=pretrained)
    return Backbone_VSSM_ST(depths=[2,2,15,2], dims=[128,128*2,128*4,128*8], ssm_ratio=2.0, ssm_drop_rate=0.6, ssm_d_state=1, forward_type="v05_noz", pretrained=pretrained)

def VSSM_L():
    return Backbone_VSSM_ST(depths=[2,2,27,2], dims=[256,256*2,256*4,256*8], ssm_ratio=2.0, ssm_drop_rate=0.6, pretrained=None, ssm_d_state=32, forward_type="v05_noz")
